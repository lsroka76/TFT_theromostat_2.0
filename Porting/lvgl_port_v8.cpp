...
void flush_callback(lv_display_t *disp, const lv_area_t *area, uint8_t *pixelmap)
{
  ...
  void flush_callback(lv_display_t *disp, const lv_area_t *area, uint8_t *pixelmap)
{
    ...
    if (lv_disp_flush_is_last(disp)) {
        ...
        lcd->drawBitmap(offsetx1, offsety1, offsetx2 - offsetx1 + 1, offsety2 - offsety1 + 1, pixelmap);
  ...
  void flush_callback(lv_display_t *disp, const lv_area_t *area, uint8_t *pixelmap)
{
    ...
    lvgl_port_rgb_next_buf = pixelmap;
#endif
...
static lv_disp_t* disp;
    ...
    disp = lv_display_create(LVGL_PORT_DISP_HEIGHT, LVGL_PORT_DISP_WIDTH);
 ...
 //   disp_drv.hor_res = LVGL_PORT_DISP_WIDTH;
   // disp_drv.ver_res = LVGL_PORT_DISP_HEIGHT;
    disp = lv_display_create(LVGL_PORT_DISP_WIDTH, LVGL_PORT_DISP_HEIGHT);
#endif
